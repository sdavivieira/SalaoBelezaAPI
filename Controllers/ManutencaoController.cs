...
namespace SalaoDeBeleza.Controllers
{
    ...
    public class ManutencaoController : ControllerBase
    {
        ...
        [HttpPost("Create")]
        public async Task<IActionResult> Create([FromBody] Manutencao colaborador)
        {
            if (colaborador == null)
            {
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] Manutencao cliente)
        {
        ...
        [HttpGet("GetManutencaoCombo")]
        public async Task<IActionResult> GetManutencaoCombo()
        {
            var _list = await _repo.GetManutencaoCombo();
            if (_list != null)
            {
                return Ok(_list);
            }
            ...
            {
                return NotFound("Não foi encontrado nenhum registro para está combo");
            }
        }
